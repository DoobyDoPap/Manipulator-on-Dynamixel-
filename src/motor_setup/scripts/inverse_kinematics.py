...
def angles():
         ...
         theta_0 = int((theta_0/Two_pi)*scale)
         theta_1 = int((theta_1/Two_pi)*scale) 
         theta_2 = int((theta_2/Two_pi)*scale) 
...
class Inverse_Publisher(Node):  
      def __init__(self):
           ...
           self.publisher_ = self.create_publisher(SetPosition, 'set_position_2', 10)
           timer_period = 0.5  
      ...
      def timer_callback(self):
        ...
        print(theta, "\n") 
        ids =[0,1,2]
        y2= np.array([0,1,2],dtype= np.int16)  
